...
public class GutendexClientImpl implements GutendexClient {
    ...
    public List<BookResponse> search(String query) {
        try {
            // Codificar el parámetro de consulta
            String encodedQuery = query.isBlank() ? "" :
            ...
            String url = API_BASE_URL + "?search=" + (!encodedQuery.isEmpty() ? encodedQuery : "");
